...
| 代號 | 日期 | 個股跳空 | 0050 同日 |
|---|---|---|---|
| 2882 | 2026-06-30 | −4.63% | +2.30% |
| 2884 | 2026-07-01 | −4.35% | +1.86% |
| 2886 | 2025-08-07 | −4.19% | +1.27% |
| 1101 | 2025-08-14 | −7.07% | −0.28% |

日期落在金控與塑化的除息季，幅度也對得上殖利率。⚠️ 這是間接證據——
「大盤漲它自己跳空跌」很強，但沒有去對真正的除息公告，修之前該對一次。
